...
@section('content')
    <section class="w-full max-w-md">
        <div class="mb-6 text-center">
            ...
            <h1 class="mt-2 text-2xl font-semibold text-gray-950">Admin sign in</h1>
            <p class="mt-2 text-sm text-gray-600">Access moderation, management, analytics, and monitoring tools.</p>
        </div>
        ...
        <div class="admin-surface p-6">
            ...
            <form method="POST" action="{{ route('admin.login.store') }}" class="space-y-4" data-loading-form>
                ...
                <x-ui.button class="w-full" data-loading-button data-loading-text="Signing in...">
                    Sign in
                </x-ui.button>
            </form>
        </div>
