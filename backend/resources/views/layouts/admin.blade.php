...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title', 'Dashboard') - Lost & Found Campus Admin</title>
            ...
            <div class="min-w-0 flex-1 lg:pl-72">
                ...
                <main class="px-4 py-6 sm:px-6 lg:px-8">
                    <div class="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <p class="text-sm font-medium text-emerald-700">Administration</p>
                            <h1 class="mt-1 text-2xl font-semibold text-gray-950">@yield('title', 'Dashboard')</h1>
                        </div>
